...
LOCK TABLES `tbl_testimonios` WRITE;
/*!40000 ALTER TABLE `tbl_testimonios` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_testimonios` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-01-05  0:00:13
